...
**Gradle:**
```groovy
implementation 'io.perfana:perfana-jmeter-timescaledb:1.5.0'
```

### Manual Installation

Download the fat JAR (`perfana-jmeter-timescaledb-1.5.0-all.jar`) from the [GitHub Releases](https://github.com/perfana/perfana-jmeter-timescaledb/releases) page and copy it to JMeter's `lib/ext` directory.
